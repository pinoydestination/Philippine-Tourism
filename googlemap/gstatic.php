...
if(isset($_GET['datatype']) && $_GET['datatype'] == "latlang"){
	$name = 'http://maps.googleapis.com/maps/api/staticmap?zoom='.$zoom.'&size='.$size.'&maptype=roadmap&markers=color:blue|label:A|'.str_replace(", ",",",urldecode($address)).'&sensor=true&key=AIzaSyAWo2NkY1CvmTYlKZRwS0P5ZfMSE5wLiiE';
}else{
