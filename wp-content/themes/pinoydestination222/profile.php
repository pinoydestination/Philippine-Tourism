...
<head>
    	<meta charset="utf-8">
		<title>Profile : Pinoy Destination - Experience Philippines - Travel. Destinations. Adventures. 100% Pinoy.</title>
		<link rel="stylesheet" href="style.css" type="text/css" media="screen" title="main styleguide" charset="utf-8"/>
		<link rel="stylesheet" href="post.css" type="text/css" media="screen" title="main styleguide" charset="utf-8"/>
		<link rel="stylesheet" href="palawan.css" type="text/css" media="screen" title="main styleguide" charset="utf-8"/>
		<link rel="stylesheet" href="blue.css" type="text/css" media="screen" title="main styleguide" charset="utf-8"/>
		<link rel="stylesheet" href="profile.css" type="text/css" media="screen" title="main styleguide" charset="utf-8"/>
	...
	<body>
			...
			<div class="container960">
				...
				<div class="mainbodycontent" id="mainDocument">
					<div class="left" id="leftSidePanel">
						<div class="postBread">
								<a href="#">Home</a> > <a href="#">Member Area</a>
							</div>
							<div class="postTitle">
								...
								<div class="profileInfoTop">
									<h1 class="title">Adam Smith</h1>
									<p>Singapore, Singapore</p><br />
									<p>
									<strong>Contributor</strong>. Traveling since 2001 and member since June 2011.
									</p>
									<span class="phonenumber">1 review</span>
								</div>
								<br clear="all" />
							</div>
						...
						<div id="mainarticlecontainer">
							...
							<div class="reviewBox" id="profileReviewBox">
								<?php for($y=0;$y<=2;$y++){ 
									if($y%2){
										$style=" whitebg";
									}else{
							...
							<div class="profileToolBar borderontop">
								<a href="javascript:void(0);" id="loadmorepost" class="loadmorepost">Load More <img id="loader" src="images/ajaxloader.gif" /></a> 
							</div>
							<div class="homepageshadow">&nbsp;</div>
		...
		<?php include("write_a_review.php"); ?>
	</body>
</html>