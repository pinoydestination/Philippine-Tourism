				...
				<div class="menucontainer">
					<div class="menu curveleft noleftmargin">
						<ul class="menulinks">
							...
							<li class="haschild"><a href="#">Restaurants</a>
								<ul>
									<li><a href="<?php echo CATEGORY_BASE; ?>/baguio-restaurant/">Baguio</a></li>
									<li><a href="<?php echo CATEGORY_BASE; ?>/manil-restaurant/">Manila</a></li>
									<li><a href="<?php echo CATEGORY_BASE; ?>/cebu-restaurant/">Cebu</a></li>
									<li><a href="<?php echo CATEGORY_BASE; ?>/davao-restaurant/">Davao</a></li>
									<li><a href="<?php echo CATEGORY_BASE; ?>/philippines/luzon/restaurant-luzon/">Luzon</a></li>
									<li><a href="<?php echo CATEGORY_BASE; ?>/restaurant-visayas/">Visayas</a></li>
									<li><a href="<?php echo CATEGORY_BASE; ?>/restaurant-mindanao/">Mindanao</a></li>
								</ul>
							</li>
							<li class="haschild"><a href="#">Hotels</a>
								<ul>
									...
									<li><a href="<?php echo CATEGORY_BASE; ?>/hotel-luzon/">Luzon</a></li>
									<li><a href="<?php echo CATEGORY_BASE; ?>/hotel-visayas/">Visayas</a></li>
									<li><a href="<?php echo CATEGORY_BASE; ?>/hotel-mindanao/">Mindanao</a></li>
								</ul>
							</li>
							<li class="haschild"><a href="#">Destinations</a>
								<ul>
									...
									<li><a href="#">Manila</a></li>
									<li><a href="<?php echo CATEGORY_BASE; ?>/destination-luzon/">Luzon</a></li>
									<li><a href="<?php echo CATEGORY_BASE; ?>/destination-visayas/">Visayas</a></li>
									<li><a href="<?php echo CATEGORY_BASE; ?>/destination-mindanao/">Mindanao</a></li>
								</ul>
							</li>
					...
					<div class="menu curveright norightmargin">
						<ul class="menulinks floatright">
							...
							<li><a href="/company/submit-a-review">Submit a Review</a></li>
