<div class="right" id="sidebarPanel">
	<div id="postsidebarcontainer">
		<div class="sidebarmap">
			<span class="myriad_pro_bold_condensed sidebarheader" style="float:left;"><?php echo get_the_title(); ?> Map</span><a class="largermapbutton fancybox fancybox.iframe" rel="nofollow" href="/googlemap/gmap.php?address=<?php echo urlencode($GLOBALS['Current_Coordinates']); ?>&zoom=13">ENLARGE MAP</a>
			<br clear="all" />
			<?php /*
