<div class="right" id="sidebarPanel">
	<div id="postsidebarcontainer">
		<div class="sidebarmap">
			<span class="myriad_pro_bold_condensed sidebarheader" style="float:left;"><?php echo get_the_title(); ?> Map</span><a class="largermapbutton fancybox fancybox.iframe" href="http://www.pinoydestination.com/googlemap/gmap.php?address=<?php echo urlencode($otherInfoData->location_address); ?>&zoom=13">ENLARGE MAP</a>
			<br clear="all" />
			<?php /*
			 ...
			 * */ ?>
			<img class="staticgmap" width="300" height="400" border="0" src="http://www.pinoydestination.com/googlemap/gstatic.php?address=<?php echo $GLOBALS['Current_Location']; ?>&zoom=13&size=292x400" />
		</div>
		<?php 
