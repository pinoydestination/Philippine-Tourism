<div class="right" id="sidebarPanel">
	<div id="postsidebarcontainer">
		<div class="sidebarmap">
			 ...
			 * */ ?>
			<img class="staticgmap" width="300" height="400" border="0" src="http://www.pinoydestination.com/googlemap/gstatic.php?address=<?php echo $GLOBALS['Current_Coordinates']; ?>&zoom=13&size=300x400" />
		</div>
		<?php 
