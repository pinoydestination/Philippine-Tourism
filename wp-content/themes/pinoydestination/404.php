<?php get_header(); ?>
<link rel="stylesheet" href="<?php bloginfo("stylesheet_directory"); ?>/404.css" type="text/css" media="screen" title="main styleguide" charset="utf-8"/>

<div class="mainbodycontent style404">
		<h1 class="myriad_pro_bold_condensed">Not Found</h1>
		<p>
			Sorry, but the post you are trying to view is not found on our server.
		</p>
</div>
