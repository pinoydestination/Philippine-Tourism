...
var WYSIWYG = {
	...
	Settings: function() {
		...
		// Images Directory
		this.ImagesDir = "/app/includes/components/rta/images/";
		
		// Popups Directory
		this.PopupsDir = "/app/includes/components/rta/popups/";
		
		// CSS Directory File
		this.CSSFile = "/app/includes/components/rta/styles/wysiwyg.css";		
