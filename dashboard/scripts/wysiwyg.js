...
var WYSIWYG = {
	...
	maximize: function(n) {
		...
		if(this.maximized[n]) {
			...
			WYSIWYG_Core.setAttribute(divElm, "style", "position:fixed;z-index:9998;top:0px;left:0px;width:" + size.width + "px;height:" + size.height + "px;");
			WYSIWYG_Core.setAttribute(tableElm, "style", "width:100%;height:" + size.Height + ";");
			WYSIWYG_Core.setAttribute(editor, "style", "width:100%;height:" + size.Height + ";");
